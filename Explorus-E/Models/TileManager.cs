...
namespace ExplorusE.Models
{
    internal class TileManager
    {
        ...
        private TileManager()
        {
            ...
            images.Add("Bubble1", new Image2D(4, ImageType.Other, tilesheet.Clone(tileBounds, tilesheet.PixelFormat)));



            //SmallBubble
            tileBounds = new Rectangle(384, 0, 48, 48);
            images.Add("Bubble2", new Image2D(5, ImageType.Other, tilesheet.Clone(tileBounds, tilesheet.PixelFormat)));
